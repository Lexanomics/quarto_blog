...
From time to time, large consortiums release valuable datasets to the public. gnomAD is one such example. Following the release of gnomAD's exome and genome data, a new dataset comprising nearly one million patients [@Sun2024] is now available for analysis and research.
